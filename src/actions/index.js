...
export const reciveMovieList = (response) => ({
	type: RECIVEMOVIELIST,
	response,
});

// Movie ActionCreators
export const reciveMovieData = (response) => ({
	type: RECIVEMOVIEDATA,
	response,
});

// Movie in Cinema ActionCreators
export const reciveCinemaMovieData = (response) => ({
	type: RECIVECINEMAMOVIEDATA,
	response,
});

export const reciveTicketDetail = (response) => ({
	type: RECIVETICKETDATA,
	response,
});

export const reciveBookingDetail = (response) => ({
	type: RECIVEBOOKINGDATA,
	response,
});
